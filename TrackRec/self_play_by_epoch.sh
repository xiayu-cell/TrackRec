...
# 设置参数前缀
modelA_folder_path=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/data/movie # 训练集文件夹名
modelA_infer_n_prefix=movielen1_tallrec_train         # 训练集文件json名 

# Generator 
modelA_save_infer_n_dir=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/G/movie_infer_n_output  # infer n次保存的文件夹
...
model_A_save_infer_dir=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/G/movie_infer_output     # model A为model Binfer训练数据的保存路径


modelB_folder_path=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/G/movie_infer_n_output      # model B infer数据的文件夹
modelB_infer_n_prefix=train_cot_step                         # model B infer的文件名
modelB_save_infer_n_dir=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/V/movie_infer_n_output  # model Binfer的保存文件夹
model_B_path=/mmu_nlp_hdd/xiayu12/Qwen2.5_7B_Instruct       # model B infer的模型路径

sample_folder_path=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/V/movie_infer_n_output      # 采样model B infer的结果的输入文件夹
sample_prefix=infer_train_ans                               # 采样model B infer的结果的输入文件名
sample_dir=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/V/movie_sample_preference_data         # 采样的保存路径
model_A_sample_dir=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/G/movie_sft_data
...
modelA_dpo_save_path=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/G/checkpoint/movie
modelB_sft_save_path=/mmu_nlp_hdd/xiayu12/safe-rlhf_official/TrackRec/V/checkpoint/movie
