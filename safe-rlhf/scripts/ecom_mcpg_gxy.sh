...
OUTPUT_DIR="${ROOT_DIR}/output/www_cot_mcpg_ecom_epoch_1"
unset HOSTFILE
ZERO_STAGE=2
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	...
	--train_datasets local-mcpg-dataset:1.0:/mmu_nlp_hdd/xiayu12/model_A/ecom_mcpg_seed/train_mcpg_step_1.json \
