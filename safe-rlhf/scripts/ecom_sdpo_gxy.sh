...
MODEL_NAME_OR_PATH="/mmu_vcg_wjc_hdd/wanglei16/paper/www2025/reco2-v1/model/our_distill_rlpf_gpt4o_Qwen2-7B-Instruct_lr1e-5_bs64_epoch1_full_train/checkpoint-312"
#MODEL_NAME_OR_PATH="/mmu_vcg2_wjc_ssd/gaoxiaoyang/aliyun/safe-rlhf_official/safe-rlhf/output/www_cot_sdpo_epoch_3"
OUTPUT_DIR="${ROOT_DIR}/output/www_cot_sdpo_ecom_epoch_1"
unset HOSTFILE
ZERO_STAGE=2
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	...
	--train_datasets local-sdpo-dataset:1.0:/mmu_nlp_hdd/xiayu12/model_A/ecom_sdpo_seed/train_sdpo_step_1.json \
