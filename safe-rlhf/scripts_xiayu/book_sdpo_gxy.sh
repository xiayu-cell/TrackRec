...
MODEL_NAME_OR_PATH="/mmu_vcg2_wjc_ssd/gaoxiaoyang/aliyun/safe-rlhf_official/safe-rlhf/output/www_cot_sdpo_book_epoch_1"
OUTPUT_DIR="${ROOT_DIR}/output/www_cot_sdpo_book_epoch_2"
unset HOSTFILE
ZERO_STAGE=2
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	...
	--train_datasets local-sdpo-dataset:1.0:/mmu_nlp_hdd/xiayu12/model_A/book_sdpo_seed/train_sdpo_step_2.json \
