...
OUTPUT_DIR="${ROOT_DIR}/output/www_cot_dpo_1029"
unset HOSTFILE
ZERO_STAGE=2
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	...
	--train_datasets local-dpo-dataset:1.0:/mmu_vcg2_wjc_ssd/gaoxiaoyang/aliyun/cot_paper/www-cot/train_data/www_cot_dpo_pairwise_20241029.json \
