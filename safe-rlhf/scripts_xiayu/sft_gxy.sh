...
MODEL_NAME_OR_PATH=/mmu_nlp_hdd/lizhiwei05/model/Qwen/Qwen2___5-7B-Instruct
OUTPUT_DIR="${ROOT_DIR}/output/www_cot_sft_epoch_4_test"
unset HOSTFILE
ZERO_STAGE=2
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	...
	--train_datasets kuaiyi-sft-dataset:1.0:/mmu_nlp_hdd/xiayu12/model_A/movie_infer_seed/sft_model_A_step_4_merge.json \
