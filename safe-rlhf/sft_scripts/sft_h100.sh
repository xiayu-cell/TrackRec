...
TRAIN_DATA_PATH=/mmu_nlp_ssd/jixingguang/long_answer_process/qwen_traindata_combine_short_0125_label_7

run_name=Qwen2-7B-stage2-long-short-prompt-combine
