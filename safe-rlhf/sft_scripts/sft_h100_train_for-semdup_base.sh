...
TRAIN_DATA_PATH=/nlp_group/linlei/sft_case_fix/dedeup_progress/train.stage2.36and10w.real.v0707_basejingyuan_for-train.json

run_name=Qwen2_7B_stage2_train_for-semdup_base
